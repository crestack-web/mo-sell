        ...
        <div style={{
          ...
          {loading && (
            <div style={{
              ...
              <span style={{ fontSize: '0.85rem' }}>MO is creating content ideas&hellip;</span>
            </div>
          )}
          ...
          <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
            <div style={{ position: 'relative', flex: 1 }}>
              <input
                ...
                placeholder="Ask MO to refine &mdash; e.g. make it more playful, shorter, add emojis&hellip;"
