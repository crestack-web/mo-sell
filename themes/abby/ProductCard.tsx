...
export function AbbyProductCard({ product, storeSlug, currency }: ThemeProductCardProps) {
    ...
    >
      {isCallout ? (
        <div className="sf-card" style={{
          ...
          boxShadow: hovered ? '0 8px 24px rgba(83,131,255,0.12)' : '0 1px 4px rgba(0,0,0,0.04)',
          transition: 'all 0.2s ease',
        }}>
          <div style={{
            width: 56, height: 56, borderRadius: 'var(--sf-radius-sm)', overflow: 'hidden', flexShrink: 0,
            background: 'var(--sf-blue-lt)',
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <span style={{ fontWeight: 800, color: 'var(--sf-blue)', fontSize: '0.95rem' }}>
      ...
      <div className="sf-card" style={{
        ...
        boxShadow: hovered
          ? '0 12px 32px rgba(83,131,255,0.12)'
        ...
        <div className="sf-card-body" style={{ padding: '14px 16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 6 }}>
            <span className="sf-card-price" style={{ fontWeight: 800, color: 'var(--sf-blue)' }}>
              {fmt(product.price, currency)}
            </span>
        ...
        <div style={{ padding: '0 16px 16px' }}>
          <button
            ...
            style={{
              ...
              background: isOutOfStock ? 'var(--sf-border)' : 'var(--sf-blue)',
