...
export function AbbyCollectionCard({ collection, storeSlug }: ThemeCollectionCardProps) {
        ...
        <div style={{
          ...
          {collection.coverImageUrl ? (
            ...
            <div style={{
              ...
              background: 'linear-gradient(135deg, #5383FF 0%, #3B6FE0 50%, #2D5CC0 100%)',
            }} />
          )}
          ...
          <div style={{
            ...
            background: hovered
              ? 'linear-gradient(135deg, rgba(83,131,255,0.3), rgba(59,111,224,0.2))'
