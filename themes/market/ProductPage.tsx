    ...
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '24px 5% 80px' }}>
      ...
      <div className="sf-product-page-grid" style={{
        ...
        <div className="sf-product-page-info" style={{ display: 'flex', flexDirection: 'column', gap: 16, order: 1 }}>
          ...
          {/* Description */}
          {product.description && (
            <div className="product-rich-description" style={{ fontSize: '0.95rem', color: '#4B5563', lineHeight: 1.65, fontWeight: 500, overflowWrap: 'break-word' }} dangerouslySetInnerHTML={{ __html: product.description }} />
          )}
