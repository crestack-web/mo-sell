...
import styles from './SellMorePage.module.css';
...
export function SellMorePage() {
  const { navigateTo, user, storeConfig, quickStats, activePage } = useSell();
    ...
    <div className={styles.page}>
      ...
      {NAV_SECTIONS.map(section => (
        <div key={section.section} className={styles.section}>
          <h2 className={styles.sectionLabel}>{section.section}</h2>
