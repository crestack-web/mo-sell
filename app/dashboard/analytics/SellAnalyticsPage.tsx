...
export function SellAnalyticsPage() {
  ...
  const conversionRate    = checkoutInitiated > 0 ? ((totalOrders / checkoutInitiated) * 100).toFixed(1) : 'â€”';

  // â”€â”€ Daily/monthly revenue chart data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.kpiGrid}>
        {[
          { label: 'Revenue', value: fmt(totalRevenue, currency), sub: `${range} Â· paid orders`,
      ...
      <div className={styles.chartCard}>
        <p className={styles.chartTitle}>Revenue â€” {range === '30d' ? 'last 30 days' : range === '90d' ? 'last 90 days' : 'last 12 months'}</p>
        {totalRevenue === 0 ? (
