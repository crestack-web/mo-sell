      ...
      <footer style={{ 
        ...
        <div style={{ maxWidth: 1160, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{
            ...
            <a href="https://tiktok.com/@trymosell" target="_blank" rel="noopener noreferrer" style={{ color: C.text2, textDecoration: 'none', display: 'flex', alignItems: 'center' }}>
