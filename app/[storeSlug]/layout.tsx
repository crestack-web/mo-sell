...
import '../../themes/luxe.css';
import '../../themes/market.css';
    ...
    <html lang="en" data-theme={theme}>
      ...
      <body>
        <CartProvider storeSlug={storeSlug}>
          ...
          {effectiveHeaderStyle !== 'minimal' && showFooter && (
            <footer className="sf-footer">
              ...
              <p>
                ...
                {footerSettings.showPoweredBy !== false && (
                  <> · Powered by <a href="https://mo-sell.store" style={{ color: 'inherit', opacity: 0.7 }}>MO Sell</a></>
                )}
              </p>
            </footer>
          )}

          {effectiveHeaderStyle !== 'minimal' && <CartDrawer storeSlug={storeSlug} currency={config.currency} />}
        </CartProvider>
      </body>
    </html>
  );
