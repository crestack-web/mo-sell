    ...
    <div style={s.container}>
      ...
      <div style={s.hero}>
        <div style={s.heroInner}>
          ...
          <h1 style={{ ...s.name, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 8, flexWrap: 'wrap' as const }}>
            <span>{creatorName}</span>
            {isVerifiedCreator(creator.email ?? creator.contactEmail) ? (
              <VerifiedBadge size={22} title="Verified creator" />
            ) : null}
          </h1>
                ...
                <div
                  ...
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                      e.preventDefault();
                      setSelectedVideo({ url: video.url });
                    }
                  }}
                >
